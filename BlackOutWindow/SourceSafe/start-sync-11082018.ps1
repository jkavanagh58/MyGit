<#
	...
	.NOTES
        ...
        11.08.2018 JJK: Verified with J Schleich that Orchestrator should be handled with synch, if statement commented out
#>
[CmdletBinding()]
Param(
...
PROCESS {
	ForEach ($ccmColl in $ccmcollections){
		...
		<# Verified with J Schleich that Orchestrator should be handled with synch
